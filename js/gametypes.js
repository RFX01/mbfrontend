...
function drawRecentGT()
{
    ...
    recentGameTypes.forEach((gt) => {
        $("#mbf-recent-gts").append(
            '<div class="col-md-3"><div class="card"><div class="card"><div class="card-body"><h5 class="card-title">' +
            gt.name +
...
{
    versionUUID = uuid;
    versionRequest.open('GET', 'https://api.madbomber.net/gametype/versions/' + uuid, true);
    versionRequest.send();
}