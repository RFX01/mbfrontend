...
function drawRecent()
{
    ...
    recentMaps.forEach((map) => {
        $("#mbf-recent-maps").append(
            '<div class="col-sm"><div class="card"><div class="card"><img class="card-img-top" src="' + 
            map.image +
...
infoRequest.onload = function () {
    ...
    $('#mbf-map-download').html('<button type="button" class="btn btn-primary btn-block" onclick="location.href=\'' + data.mbm + '\'">Download</button>');
